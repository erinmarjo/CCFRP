...
Of the regional climate indices included in the MOCI calculation, PDO is often used as a predictor of biology. The Pacific Decadal Oscillation is an index that measures variability in sea surface temperature and has been described as a long-lived El Nino-like pattern (Mantua and Hare 2001). There may be one or more parameters of MOCI that drive the correlation between environmental variability in rockfish CPUE. To test this, I will calculate cross correlations between PDO values and Blue rockfish CPUE. The prediction being that if PDO is the main driver of the relationship between environmental variability and rockfish CPUE, the magnitude of the correlation will be higher. I predict that the single value of MOCI will be a stronger predictor of biology than any one parameter alone, though there may be some parameters (like PDO) that are more relevant than others. I predict PDO may be driving the relationship to some extent, so we will see the same lags as with MOCI (~2 years summer for juveniles; ~ 1-2 years for adult) with similarly high correlations. I will not test each component part of MOCI, but rather the drivers that have been shown to be strong predictors of biology.
