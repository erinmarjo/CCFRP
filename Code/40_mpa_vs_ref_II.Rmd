...
dos_mod_1a <- lmerTest::lmer(cpue_cell ~ site*bda + (1|area), data = single_glm_dat2a2)
anova(dos_mod_1a)
summary(dos_mod_1a)
...
```{r eight two way repeated measures ANOVA}
...
```{r juv and adult two way repeated measures ANOVA}
...
```{r rep measures ANOVA new guide}
library(ggpubr)
library(rstatix)
## Data preparationb
